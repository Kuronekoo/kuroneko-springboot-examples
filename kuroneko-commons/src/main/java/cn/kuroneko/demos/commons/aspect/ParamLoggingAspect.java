package cn.kuroneko.demos.commons.aspect;

import cn.kuroneko.demos.commons.annotation.ParamLogging;
...
public class ParamLoggingAspect {
    ...
    @Pointcut("@annotation(cn.kuroneko.demos.commons.annotation.ParamLogging)")
